...
//Public ke neechey jitney bhi Data memeber ya data Function hongey toh vo class ke ander bhi acces ho sktey hai aur class ke bahar kahi bhi
    ...
    /*
    1.) In C++, We can have more than one constructor in a class with same name, as long as each has a different list of arguments.This concept is known as Constructor Overloading (Not in JS)
